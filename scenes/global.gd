...
const FRUIT_DATA = {
	...
	FruitType.STRAWBERRY: { "name": "STRAWBERRY", "score": 2, "scale": 24, "color": "#d70035" },
	FruitType.GRAPE: { "name": "GRAPE", "score": 4, "scale": 32, "color": "#56256e" },
	FruitType.DEKOPON: { "name": "DEKOPON", "score": 8, "scale": 40, "color": "#f6ae54" },
	...
	FruitType.MELON: { "name": "MELON", "score": 512, "scale": 112, "color": "#65ab31" },
